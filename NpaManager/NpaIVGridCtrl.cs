...
namespace NpaManager {
   public partial class NpaIVGridCtrl : NpaGridBase {
      ...
      public override void AddNewRow() {
         ...
         if (pos >= 0) {
            ...
            NpaDataSet.NpaIVRow oldRow = drv.Row as NpaDataSet.NpaIVRow;
            index = oldRow.Index;

            if (pos < bindingSrc.Count - 1) {
               drv = bindingSrc[pos + 1] as DataRowView;
               NpaDataSet.NpaIVRow oldRow1 = drv.Row as NpaDataSet.NpaIVRow;
      ...
      public override void ClearSelectedDeadlines() {
         ...
         foreach (int rowHandle in selectedHandlers) {
            ...
            NpaDataSet.NpaIVRow row = drv.Row as NpaDataSet.NpaIVRow;
            row.ClearDeadlines();
         }
      }
      ...
      /// </summary>
      private static DialogResult AddNewNpa(NpaDataSet.NpaIVRow row) {
         AddNpaIVDialog dialog = new AddNpaIVDialog(row);
      ...
      private void SetDateTimeMaxValues(int RowHandle) {
         // PlanDateLaw
         object val = gridView1.GetRowCellValue(RowHandle, colRegDateLaw);
      ...
      /// Обновить историю
      /// </summary>
      private void UpdateHistory(NpaDataSet.NpaIVRow row) {
